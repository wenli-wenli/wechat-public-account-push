export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe077f1044aac1ae0",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "daa4d7491273fec8f7ed3af8908cbe53",
  ...
  USERS: [
    {
      ...
      id: "oqpW45qziqxMfpB2jUKV0IyhrKZs",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "v0WSml5okZ-CITOd6nZjanubOh-cBXARE6wFfQHa93I",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "青岛",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝的阴历", "year": "2000", "date": "04-10"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "宝的阳历", "year": "2000", "date": "05-13"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2018-06-20"},
      ]
    },
    {
      name: "老婆1",
